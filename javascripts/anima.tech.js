...
function createStage(containerId, metaName){

	width = Number(getMeta(metaName).split("width=")[1].split(",")[0]);
	height = Number(getMeta(metaName).split("height=")[1].split(",")[0]);

	document.getElementById(containerId).style.width = width + "px";
