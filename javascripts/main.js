...
;(function ($) {
      ...
      var textchart = new Highcharts.Chart({
        ...
        series: [
        {
            ...
            data: [{
              ...
              name: window.translations.registrations_chart.text_6_to_10_domains,
              y: textChartData[5],
              color: '#003D63'
            }, {
              name: window.translations.registrations_chart.text_11_to_25_domains,
              y: textChartData[6],
              color: '#3EB54C'
            }, {
              name: window.translations.registrations_chart.text_26_to_50_domains,
              y: textChartData[7],
              color: '#00BABE'
            }, {
              name: window.translations.registrations_chart.text_51_to_100_domains,
              y: textChartData[8],
              color: '#FBAA19'
            }, {
              name: window.translations.registrations_chart.text_101_to_200_domains,
              y: textChartData[9],
              color: '#FF6E00'
            }, {
              name: window.translations.registrations_chart.text_201_to_500_domains,
              y: textChartData[10],
              color: '#447BBF'
            }, {
              name: window.translations.registrations_chart.text_501_to_1000_domains,
              y: textChartData[11],
              color: '#3A3794'
            }, {
              name: window.translations.registrations_chart.text_1001_to_2000_domains,
              y: textChartData[12],
              color: '#009DE1'
            }, {
              name: window.translations.registrations_chart.text_2001_or_more_domains,
              y: textChartData[13],
              color: '#000'
            }],
          }]
  ...
  var initOrgChart = function () {
    var orgChartData = [];
    $.when(
      $.ajax({type: 'GET', url: DATA_HOST + '/data_org_type.json', dataType: 'JSON'}).done(function (response) {
        if (response) {
