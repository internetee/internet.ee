...
const paths = {
    ...
    js: {
        ...
        charts: [
            ...
            "sources/javascripts/charts/world-map.js"
        ]
    },
    print: "sources/stylesheets/print.css",
    voogFiles: ["assets/", "components/", "images/", "javascripts/", "layouts/", "stylesheets/"]
};
...
exports.print = print;
exports.watch = () => watch([paths.styles, paths.scripts], styles, scripts, charts)
