<script type="text/javascript">
  ...
  data: {% include "extend-graph-data" %}
  ...
  data: {% include "register-graph-data" %}
  },
  {
  ...
  //pointInterval:12 * 3600 * 100,
        pointInterval: 24 * 3600 * 1000,
  name:"Kustumised",
  data: {% include "deletion-graph-data" %}
  ...
  data: {% include "dnssec-graph-data" %}
