...
<head prefix="og: http://ogp.me/ns#">
	...
	<meta name="mobile.size" content="width=600,height=500">
	<meta name="game.size" content="width=1296,height=360">
  ...
  {% stylesheet_link "custom-2022.css?v=2" %}
...
<main class="page-content" role="main">
  <article class="page--detail" data-search-indexing-allowed="true">
    ...
    <div class="page--content">
		...
		<section class="ee-search">
			...
			<div class="ee-search__wrapper">
				<div id="app-dsearch">
					<div class="ee-search__content">
						...
						<div class="ee-search__domain-info">
							...
							<a v-if="message != '' && isAvailable" href="https://www.internet.ee/registripidajad" target="_blank" class="ee-btn">Registreerima</a>
				...
				<div class="ee-search__result">
					<div id="dude-static" style="display: block;"><img src="/images/ee-dude.png" alt=""></div>
					<div id="anima-win-container" class="ee-dance" style="display: none;">
						<div id="anima-win" class="konvagsapcontainer"></div>
						Selline näeb välja domeenivõidutants.
					</div>
					<div id="anima-lose-container" class="ee-dance" style="display: none;">
						<div id="anima-lose" class="konvagsapcontainer"></div>
						Selline näeb välja domeenist ilmajäämise tants.
					</div>
				</div>
				<div id="clicker"></div>
				<div id="out"></div>
			...
			<script src="{{ javascripts_path }}/anima.lose.js"></script>
			<script>
		...
		<section class="ee-title-section">
			{% content name="ee-title" %}
		</section>

		<section class="ee-fifty-fifty">
			<div>
				{% content name="fifty-left" %}
			</div>
			<div>
				{% content name="fifty-right" %}
			</div>
		</section>

		<section class="ee-banner-game">
			<div id="container" class="konvagsapcontainer"></div>

			<!--<script src="{{ javascripts_path }}/anima.loader.js"></script>-->
			<script src="{{ javascripts_path }}/game.tech.js?v=3"></script>
			
			<script src="{{ javascripts_path }}/game.main.js?v=3"></script>
			<script src="{{ javascripts_path }}/game.goodGuy.js?v=3"></script>
			<script src="{{ javascripts_path }}/game.badGuy.js?v=3"></script>
			<script src="{{ javascripts_path }}/game.goodVictory.js?v=3"></script>
			<script src="{{ javascripts_path }}/game.badVictory.js?v=3"></script>
			<script src="{{ javascripts_path }}/game.badLoser.js?v=3"></script>
			<script src="{{ javascripts_path }}/game.goodLoser.js?v=3"></script>
			<script>
				if (typeof gsap === 'undefined') {
					document.getElementById("container").innerHTML = '<span class="adblocker"><b>Magic is on the way!</b><br/>You just need to disable ad-blocker</span>';
				}
		...
		<section class="ee-mobile-game">
			<img src="/images/ee-mobile-game.jpg" alt="">
		</section>

		<section class="ee-story ee-story--has-shadow">
			<div class="ee-story__content">
				{% content name="story-1" %}
			</div>
			<div class="ee-story__illustration">
				<img src="/images/ee-illustration-1.png" alt="">
			</div>
		</section>

		<section class="ee-frequency ee-frequency--has-shadow">
			<div class="ee-frequency__content">
				{% content name="frequency" %}
			</div>
			<div class="ee-frequency__illustration">
				<img src="/images/ee-domeenikaart_n.jpg" alt="">
			</div>
		</section>

		<section class="ee-story ee-story--reversed">
			<div class="ee-story__content">
				{% content name="story-2" %}
			</div>
			<div class="ee-story__illustration">
				<img src="/images/ee-illustration-3.png" alt="">
			</div>
		</section>

		<section class="ee-highlight">
			<div class="ee-highlight__illustration">
				<img src="/images/ee-illustration-4.png" alt="">
			</div>
			<div class="ee-highlight__content">
				{% content name="highlight" %}
				<!--<a href="https://www.internet.ee/domeenivaidlused/domeenivaidluste-komisjon" class="ee-btn ee-btn--bordered">PÖÖRDU!</a>-->
			</div>
		</section>

		<section class="ee-story ee-story--special-margin">
			<div class="ee-story__content">
				{% content name="story-3" %}
			</div>
			<div class="ee-story__illustration">
				<img src="/images/ee-illustration-8.png" alt="">
			</div>
		</section>
  ...
  var domainSearch = new Vue({
    ...
    methods: {
      ...
      showDomainMessage: function (type, name) {
		...
		document.getElementById('dude-static').style.display = 'none';

		if( this.isAvailable ){
			document.getElementById('anima-win-container').style.display = 'block';
			document.getElementById('anima-lose-container').style.display = 'none';
			return;
		}

		document.getElementById('anima-lose-container').style.display = 'block';
		document.getElementById('anima-win-container').style.display = 'none';
        ...
        if (this.queryString.length > 1) {
          ...
          if (this.isValid(domain)) {
			...
			if( typeof window.gtag !== 'undefined' ){
				// Send event info using gtag.js
				window.gtag('event', 'Otsi', {
					'event_category': 'Button_click',
					'event_label':'Firmanimi',
				});
			}
