...
<head prefix="og: http://ogp.me/ns#">
  ...
  {% stylesheet_link "custom-2022.css" %}
  ...
  <article class="page--detail" data-search-indexing-allowed="true">
    ...
    <div class="page--content">
		...
		<section class="ee-search">
			...
			<div class="ee-search__wrapper">
				...
				<div class="ee-search__result">
					<div id="anima-win" style="display: none;" class="konvagsapcontainer"></div>
					<div id="anima-lose" style="display: none;" class="konvagsapcontainer"></div>
				</div>
				<div id="clicker"></div>
				<div id="out"></div>
			</div>
		...
		<section class="ee-banner-game">
			...
			<!--<script src="{{ javascripts_path }}/anima.loader.js"></script>-->
			<script src="{{ javascripts_path }}/game.tech.js"></script>
			
			<script src="{{ javascripts_path }}/game.main.js"></script>
			<script src="{{ javascripts_path }}/game.goodGuy.js"></script>
			<script src="{{ javascripts_path }}/game.badGuy.js"></script>
			<script src="{{ javascripts_path }}/game.goodVictory.js"></script>
			<script src="{{ javascripts_path }}/game.badVictory.js"></script>
			<script src="{{ javascripts_path }}/game.badLoser.js"></script>
			<script src="{{ javascripts_path }}/game.goodLoser.js"></script>
			<script>
				if (typeof gsap === 'undefined') {
					document.getElementById("container").innerHTML = '<span class="adblocker"><b>Magic is on the way!</b><br/>You just need to disable ad-blocker</span>';
				}
		...
		<section class="ee-stories-title">
			{% content name="ee-stories-title" %}
		</section>
		...
		<section class="ee-story ee-story--special-margin">
			...
			<div class="ee-story__illustration">
				<img src="/images/ee-illustration-7.png" alt="">
			</div>
		</section>
  ...
  var domainSearch = new Vue({
    ...
    methods: {
      ...
      showDomainMessage: function (type, name) {
		...
		if( this.isAvailable ){
			document.getElementById('anima-win').style.display = 'block';
			document.getElementById('anima-lose').style.display = 'none';
			return;
		}

		document.getElementById('anima-lose').style.display = 'block';
		document.getElementById('anima-win').style.display = 'none';
